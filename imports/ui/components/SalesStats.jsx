                    ...
                    >
                    {
                            typeof getEvents!= "undefined" && getEvents.length ?getEvents.map((row,index)=>{
                                    return(<TableRow key={index} className="animated bounceInLeft"  ref={`user${index}`}>
                                            ...
                                            <TableRowColumn title={row.assignedToEvent}>{row.assignedToEvent}</TableRowColumn>
                                            <TableRowColumn title={row.eventName}>{row.eventName}</TableRowColumn>
                                            <TableRowColumn title={row.redac}>{row.redac}</TableRowColumn>
                                            <TableRowColumn title={moment(row.dateCreation).format(LLL)}>{moment(row.dateCreation).format(LLL)}</TableRowColumn>    
                                    </TableRow>);
                                }):<TableRow>
